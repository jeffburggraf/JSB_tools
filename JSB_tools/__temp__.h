...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/jeffreyburggraf/PycharmProjects/PHELIX/Shot_data_analysis/ROOTTTrees2/_shot52.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Users/jeffreyburggraf/PycharmProjects/PHELIX/Shot_data_analysis/ROOTTTrees2/_shot52.root");
      }
