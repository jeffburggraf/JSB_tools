...
if __name__ == '__main__':
    # p = Path('/Users/burgjs/PycharmProjects/miscMCNP/detectorModels/RMET3/Xrays/xray_center1.tif')
    p =Path('/Users/burgjs/PycharmProjects/miscMCNP/detectorModels/RMET3/Xrays/xray_center1.pickle')
